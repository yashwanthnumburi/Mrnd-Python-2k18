...
-sets dont have duplicate values
-sets have operations such as union,intersection,difference,symetricdifference
-sets dont follow any specific order in storage and sets cannot have list as its elements=
"""
