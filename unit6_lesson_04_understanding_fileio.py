...
-I have learnt how to open files read files write files.
-I came to know the differences between read,readline,readlines.
-I came to know to use with statement and tell,seek functions also.
"""