...
-I have learnt how to sort list
-how to reverse list,how to append two lists,how to create a list using range
-i came to know how use slicing and indexing of lists
"""