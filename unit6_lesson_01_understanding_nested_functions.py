...
def test_inner_func_attributes():
    ...
    ref_to_outer_scope =outer_func.__reduce__
...
-I have learnt how inner functions that are defined in a function.
-I have came to know how the scope of variables works in nested functions
-I have learnt how to change the value of a variable of outer function in inner function using nonlocal keyword
"""
