...
def test_lambda_syntax():
    ...
    #write your first lambda below3 !
...
-I have learnt what are anonymus functions ie lambda functions
-I have seen these are useful in many conditions and i came to know that extra variables used in lambda functions must be declared previously
-The calculation of variables in lambda functions is done at runtime
"""