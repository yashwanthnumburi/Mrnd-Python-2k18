...
-I have learnt how to handle runtime time exceptions
-I have learnt the flow of execution of try ,except,finally
-I have learnt when else is entered and about nestes try's
"""
