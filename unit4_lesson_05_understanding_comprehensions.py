...
-I have learnt what are the different types of comprehensions 
-I have learnt how to create comprehensions
-Writing small codes in the sense small lines of code
-I have learnt how to generate prime numbers using single line code with comprehensions
"""
