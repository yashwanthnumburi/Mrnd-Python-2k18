...
-I have learnt how to write if elif else for while control flows
-I have learnt for else control flow and how it is going to work
-came to know pass -it does nothing after executing it
"""