...
def test_assert_true():
    assert 10 #This should be True -- replace ___ with True.

def test_assert_true_with_message():
    print("test print")
    assert 10 , "This is the failure message" # what error do you see when you run this test?
...
def test_make_assert_true_2():
    assert  3**30 > 2**30, "Fill in value greater than 2**30"
...
-I have learnt how to use assert statement
-I have learnt a new exception called Assertion Error when the condition hasnt satisfied in assert
-assert statement is going to help in debugging in some cases
"""