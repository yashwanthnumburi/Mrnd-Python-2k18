...
-How to write functions with parameter
-Came to know about the format keyword 
-came to know that there is another parameter for inbuilt min function ie key=somefunction
-there will be different types of parameters total 5-positional or keyword,postional only,keyword only,var-positional,var-keyword
-arguments are of three types -keyword arguments and positional arguments
-python neither uses call by reference nor call by value it uses call by object sharing
"""