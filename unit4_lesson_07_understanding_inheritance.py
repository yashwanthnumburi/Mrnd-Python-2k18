...
-I have learnt how to inherit classes.
-I have learnt how to override parent class functions.
-I have learnt what happens when inherited class objects call parents functions and parent class objects when they call child
classes functions then attribute error raises. 
"""
