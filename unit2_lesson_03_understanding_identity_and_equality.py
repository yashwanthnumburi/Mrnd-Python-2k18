...
-objects of same type returns true using is and updating one updates all the objects belonging to it
-came to know that python uses array like thing to store numbers of range -5 to 256 and hence they belong to same class
-above 256 they belong to differnt objects and is operator is not perefferd with integers
-python uses a cache for small ints and whenever they are created they will be from the cache instead of a new one
"""
