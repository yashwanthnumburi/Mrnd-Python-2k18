...
def test_module_without_import():
    try:
        ...
        print("NameError: name 'module1' is not defined")    # print it out and see
        assert True
...
-I have learnt the three different ways of importing modules
-I have found that importing module with import is far better that remaining
-we cannot import module using * inside a function
"""
