...
def test_decorators_arguments():
    ...
    def runif(variable):
        pass
        def inner():
            if variable=="MY_LINUX":
                os.register("MY_LINUX")
            elif variable=="MY-WINDOWS":
                os.register("MY_WINDOWS")
...
-How to write a genric code for different functions using decorators
-I have learnt what are the ways to call decorator
-I have learnt how to use wraps and importing functiontools to preserve the main function after calling decorator
"""
