...
def test_tuple_with_one_element():
    test1 = (1)
    assert 'tuple' == type(test1).__name__
...
def min_max(input):
    ...
    """
    return tuple((min(list(input)),max(list(input))))  # write a line of code to return containing min and max
...
-I have learnt how the tuples are created
-how to use slicing and indexing with tuples
-how to use min and max with tuples,how to convert a list of characters into tuples or from set to tuples using join
"""
