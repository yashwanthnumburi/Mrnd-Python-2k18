...
def test_dictionary_is_unordered():
    ...
    equal = (dict1 == dict2)
    assert False == equal # True or False?
...
def test_dictionary_contains():
    ...
    assert True== (1 in word_to_digit)
    assert True== (2 in word_to_digit)
...
-how to use dicts,how to change the value using key
-how to del a key value pair,how to use zip
-here i have came to know the difference between sort and sorted where sort changes the original data type whereas sorted 
return the new sorted type
"""
