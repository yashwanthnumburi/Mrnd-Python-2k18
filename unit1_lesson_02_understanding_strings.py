...
def test_string_formatting_literals():
    ...
    """
    value = 10
    assert  10== f"value is: {value}"
    value = 20
    assert 30 == f"value is: {value + 10}"
    name, age = "Ramu", 20
...
-slicing of strings
-many inbuilt functions such as upper() lower() swapcase() find() 
-learned to write a single line of code for rotating string right side without any swapping 
came to know about the importance of slicing and concatenation in strings.
"""
